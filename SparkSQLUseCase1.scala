...
object SparkSQLUseCase1 {
 ...
 case class hvac_cls(Date:String,Time:String,TargetTemp:Int,ActualTemp:Int,System:Int,SystemAge:Int,BuildingId:Int)
  ...
  def main(args: Array[String]): Unit = {
    ...
    val data = spark.sparkContext.textFile("D:/hadoopstudy/interviewsessionII/session21/HVAC.csv");
   ...
   val data2 = spark.sparkContext.textFile("D:/hadoopstudy/interviewsessionII/session21/building.csv");
